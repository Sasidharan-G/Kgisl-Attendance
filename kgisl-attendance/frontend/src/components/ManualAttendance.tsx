    ...
    <section className="rounded-2xl border border-ink-border bg-ink-850/60 p-4 shadow-card sm:p-6">
      <div className="mb-4 flex items-start gap-2">
        ...
        <div>
          ...
          <p className="mt-1 text-[10px] leading-relaxed text-slate-500">Mark a student present if Alpha or Beta fails. Override to absent when proxy attendance or fraud is confirmed. Every change is audited.</p>
        </div>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-3">
        ...
        <div>
          ...
          <div className="mt-1 flex justify-between text-[9px] text-slate-600"><span>A reason is required and will be saved in the audit log</span><span>{reason.length}/200</span></div>
        </div>
