...
import { createBatch, createRoom, createSubject, listBatches, listRooms, listSubjects, updateBatch } from '../services/api.js';
...
export default function AcademicSetupPage() {
  ...
  const load = async () => { const [batchData, subjectData, roomData] = await Promise.all([listBatches(), listSubjects(), listRooms()]); setBatches(batchData); setSubjects(subjectData); setRooms(roomData); };
  useEffect(() => { load(); }, []);
